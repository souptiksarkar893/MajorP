  ...
  return (
    <div className="flex flex-col items-center mx-auto w-3/4 mb-12">
      ...
      <div className="">
        <div className="mt-6">
          <p>
            GoatStay is a real estate management platform that helps you to find
            and manage your rentals in one place. You can either register as a
            property owner or a tenant. The property owner can post their
      ...
      <div>
        <header className="flex m-1 shadow-sm">
          ...
          <div className="flex flex-col justify-center ml-2">
            <h5 className="font-display">GoatStay</h5>
            <p className="hidden text-xs md:block md:text-sm">
              Your one-stop platform to find, manage, and rent properties with
              ease.
            </p>
          </div>
        </header>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <div className="flex items-center mb-4 sm:mb-0">
              ...
              <div className="flex flex-col ml-3 justify-center">
                <h1 className="font-display text-xl md:text-2xl">GoatStay</h1>
                <p className="text-xs md:text-sm">
                  The ultimate platform to find, manage, and rent properties
                  effortlessly.
                </p>
              </div>
            </div>
