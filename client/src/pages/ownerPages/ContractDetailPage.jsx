  ...
  return (
    <main className="mb-12">
      ...
      <div className="flex flex-col gap-2 items-center mt-4 text-center">
        ...
        <div>
          <h5 className="font-robotoNormal">
            <span className="font-medium">Rent Amount</span>: INR.{" "}
      ...
      <div className="w-11/12 mx-auto text-justify mt-6">
        ...
        <p>
          ...
          <strong>INR {format(contractDetail?.rentAmount)}</strong> per month.
          Total Rent amount of{" "}
          <strong>INR {format(calculateTotalRent())}</strong> shall be due and
